  ...
  return `
    <div class="qibla-visual" data-qibla-visual aria-label="بوصلة القبلة">
      <img
        ...
        src="./assets/icons/sections/qibla/qibla-left-sujud.svg"
        alt=""
        aria-hidden="true"
        loading="lazy"
        decoding="async"
      ...
      >
        <img
          ...
          src="./assets/icons/sections/qibla/qibla-compass.svg"
          aria-hidden="true"
          alt=""
          loading="lazy"
          decoding="async"
      ...
      <img
        ...
        src="./assets/icons/sections/qibla/qibla-right-tasbee.svg"
        alt=""
        aria-hidden="true"
        loading="lazy"
        decoding="async"
