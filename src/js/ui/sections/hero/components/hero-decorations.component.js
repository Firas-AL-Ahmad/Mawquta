export function renderHeroDecorations() {
  return `
    ...
    <span class="hero__corner hero__corner--bottom-left" aria-hidden="true"></span>
    <span class="hero__corner hero__corner--bottom-right" aria-hidden="true"></span>
